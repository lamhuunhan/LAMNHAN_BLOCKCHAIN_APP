...
public class LamNhan_Chain {
    ...
    public static TCWallet walletA; //Ví A
    public static TCWallet walletB; //Ví B
    ...
    public static void main(String[] args) {
        ...
        //Tạo ra các ví
        walletA = new TCWallet();
        walletB = new TCWallet();
        TCWallet coinbase = new TCWallet();
